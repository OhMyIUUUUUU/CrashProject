    ...
    -- Reports table (UPDATED Default Value)
    ...
    -- ============================================================
    -- STEP 6: AUTO-CONNECT SOS FUNCTION (UPDATED)
    -- ============================================================
    ...
    -- [UPDATED] Use 'Pending' (capitalized) and cast to enum type
    ...
    VALUES (
        ...
        p_category,
        p_description,
        'Pending'::report_status_enum,  -- FIXED: Capitalized and cast to enum
        NOW()
    )
